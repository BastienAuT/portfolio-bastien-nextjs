...
const copy = {
  fr: { caseStudy: "Voir l’étude de cas", open: "Ouvrir le site", tech: "Technologies utilisées pour", openAria: "Ouvrir le site", repoAria: "Ouvrir le dépôt GitHub de", recent: "Travaux récents", title: "Projets sélectionnés", intro: "Deux réalisations menées en contexte professionnel et cinq produits personnels conçus de bout en bout, dont Cyclone présenté ci-dessus.", proEyebrow: "01 · Contexte professionnel", proTitle: "Réalisations professionnelles", proDescription: "Des fonctionnalités livrées dans un cadre de travail réel, avec un périmètre précis et des contraintes produit existantes.", personalEyebrow: "02 · Recherche personnelle", personalTitle: "Produits personnels", personalDescription: "Des applications conçues et développées de bout en bout pour approfondir l’architecture, la qualité et l’expérience produit." },
  en: { caseStudy: "View case study", open: "Open website", tech: "Technologies used for", openAria: "Open the website", repoAria: "Open the GitHub repository for", recent: "Recent work", title: "Selected projects", intro: "Two projects delivered in a professional setting and five personal products designed and built end to end, including Cyclone above.", proEyebrow: "01 · Professional context", proTitle: "Professional work", proDescription: "Features delivered in a real work environment, within a defined scope and existing product constraints.", personalEyebrow: "02 · Personal exploration", personalTitle: "Personal products", personalDescription: "Applications designed and developed end to end to deepen my work on architecture, quality, and product experience." },
};
